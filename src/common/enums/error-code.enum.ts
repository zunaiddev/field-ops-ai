export enum ErrorCode {
    ...
    TECHNICIAN_ALREADY_EXISTS = 'TECHNICIAN_ALREADY_EXISTS',
    INVALID_EMPLOYEE_ROLE = 'INVALID_EMPLOYEE_ROLE',
    TECHNICIAN_NOT_FOUND = 'TECHNICIAN_NOT_FOUND',
    NOT_ALLOWED = 'NOT_ALLOWED',
    SERVICE_NOT_FOUND = 'SERVICE_NOT_FOUND',
    SERVICE_NOT_DELETABLE = 'SERVICE_NOT_DELETABLE',
    SERVICE_NOT_UPDATABLE = 'SERVICE_NOT_UPDATABLE',
    SCHEDULE_NOT_UPDATABLE = 'SCHEDULE_NOT_UPDATABLE',
