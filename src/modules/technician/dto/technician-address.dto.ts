...
export class TechnicianAddressDto {
    @Trim()
    ...
    @MaxLength(100, {message: "Longitude cannot exceed 100 characters"})
    longitude: string;
    ...
    @MaxLength(100, {message: "Latitude cannot exceed 100 characters"})
    latitude: string;
}